...
export const orderDetailsReducer = (state = { loading: true }, action: any) => {
  switch (action.type) {
...
export const orderMineListReducer = (state = { orders: [] }, action: any) => {
  switch (action.type) {
...
export const orderDeleteReducer = (state = {}, action: any) => {
  switch (action.type) {
